      ...
      <ScrollView>
                ...
                <View>
                  {tour.images.map((gallery: any, index: number) => (
                    <TouchableOpacity key={index} style={{
                      ...
                      <Image source={gallery.image} style={{ width: "100%", height: "100%", borderRadius: SPACING }} />
                    </TouchableOpacity>
                  ))}
                </View>
              </View>
        ...
        <View style={{
          ...
          <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
            <Text style={{ fontSize: SPACING * 2, fontWeight: "bold", color: COLORS.dark }}>{tour.title}</Text>
            <View style={{ flexDirection: "row", alignItems: "flex-end" }}>
              <Text style={{ fontSize: SPACING * 2, fontWeight: "bold", color: COLORS.dark }}>{tour.price}</Text>
              <Text>/person</Text>
            </View>
          </View>
          <View style={{ marginVertical: SPACING * 2 }}>
            <View style={{ flexDirection: "row", marginBottom: SPACING * 2 }}>
              <TouchableOpacity style={{ paddingVertical: SPACING, marginRight: SPACING * 2 }}>
                <Text style={{ color: COLORS.primary, fontWeight: "bold", fontSize: SPACING * 1.7 }}>Overview</Text>
              </TouchableOpacity>
              <TouchableOpacity style={{ paddingVertical: SPACING, marginRight: SPACING * 2 }}>
                <Text>Reviews</Text>
              </TouchableOpacity>
            ...
            <View style={{ marginBottom: SPACING * 2, flexDirection: "row" }}>
              <View style={{ flexDirection: "row" }}>
                ...
                <View style={{ marginRight: SPACING * 2 }}>
                  ...
                  <Text style={{ fontSize: SPACING * 1.6, fontWeight: "700" }}>{tour.duration}</Text>
                </View>
              </View>
              <View style={{ flexDirection: "row" }}>
                <View style={{
                ...
                <View style={{ marginRight: SPACING * 2 }}>
                  ...
                  <Text style={{ fontSize: SPACING * 1.6, fontWeight: "700" }}>{tour.rating} out of 5</Text>
                </View>
              </View>
            </View>
            <View>
